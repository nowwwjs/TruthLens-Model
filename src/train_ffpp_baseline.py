...
def get_model(num_classes: int = 2):
    # torchvision의 ResNet18을 기반으로 한 이진 분류 모델 생성.

    # ImageNet으로 사전 학습된 ResNet18 불러오기
...
def main():
    ...
    # 베스트 모델 저장 경로
    # -> 여기서 저장한 .pth를 evaluate_ffpp_baseline에서 그대로 사용
    best_model_path = WEIGHTS_DIR / "ffpp_resnet18_baseline.pth"
