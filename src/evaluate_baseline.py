...
EVALUATION_TASKS = [
    {
        "name": "Scenario 1: FF++ Baseline (Self-Evaluation)",
        "csv_path": INDICES_DIR / "ffpp_test.csv",
        "model_path": WEIGHTS_DIR / "ffpp_resnet18_baseline.pth",
    },
    {
        "name": "Scenario 2: Celeb-DF Fine-tuned (Self-Evaluation)",
        "csv_path": INDICES_DIR / "celebdf_test.csv",
        "model_path": WEIGHTS_DIR / "celebdf_resnet18_finetuned.pth",
    },
    # (옵션) Cross Evaluation: FF++ 모델로 Celeb-DF 평가하기
    # {
    #     "name": "Scenario 3: Cross-Eval (FF++ Model on Celeb-DF)",
    #     "csv_path": INDICES_DIR / "celebdf_test.csv",
    #     "model_path": WEIGHTS_DIR / "ffpp_resnet18_baseline.pth"
    # }
]
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Evaluate Baseline Models Sequentially"
    )
